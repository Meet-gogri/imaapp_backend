...
SMTP_HOST = os.getenv("smtppro.zoho.in")
SMTP_PORT = int(os.getenv("465"))
SMTP_USER = os.getenv("no_reply@policyera.com")
SMTP_PASS = os.getenv("EvLTUpMTLWeQ")
SMTP_FROM = os.getenv("no_reply@policyera.com")
